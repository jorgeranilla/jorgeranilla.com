...
document.addEventListener("DOMContentLoaded", () => {
  ...
  (function buildBreadcrumbs() {
    ...
    const PAGE_HIERARCHY = {
      ...
      'heritage-roots': ['Family', 'Heritage & Roots'],
      'extended-family': ['Family', 'Heritage & Roots', 'Extended Family'],
      'family-tree': ['Family', 'Heritage & Roots', 'Family Tree'],
      'ancestry': ['Family', 'Heritage & Roots', 'Ancestry'],

      // Family section - Individual pages (under Heritage & Roots)
      "alyssa-ranilla": ['Family', 'Heritage & Roots', "Alyssa Ranilla"],
      "jorge-ranilla": ['Family', 'Heritage & Roots', "Jorge Ranilla"],
      "jorge-ranilla-cateriano": ['Family', 'Heritage & Roots', "Jorge Ranilla Cateriano"],
      "maria-ranilla": ['Family', 'Heritage & Roots', "Maria Ranilla"],
      "shane-ranilla": ['Family', 'Heritage & Roots', "Shane Ranilla"],
      "sylvia-astocondor-salazar-lopez": ['Family', 'Heritage & Roots', "Sylvia Astocondor Salazar Lopez"],
      "victor-ranilla": ['Family', 'Heritage & Roots', "Victor Ranilla"],

      // Family section - Extended family pages
      "adriana-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Adriana Astocondor"],
      "alcira-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Alcira Astocondor"],
      "alcira-lopez-ruiz": ['Family', 'Heritage & Roots', 'Extended Family', "Alcira Lopez Ruiz"],
      "alessandra-briceno": ['Family', 'Heritage & Roots', 'Extended Family', "Alessandra Briceno"],
      "aurora-rondon-perea": ['Family', 'Heritage & Roots', 'Extended Family', "Aurora Rondon Perea"],
      "carlota-astocondor-salazar-lopez": ['Family', 'Heritage & Roots', 'Extended Family', "Carlota Astocondor Salazar Lopez"],
      "carlota-ruiz-guevara": ['Family', 'Heritage & Roots', 'Extended Family', "Carlota Ruiz Guevara"],
      "carlota-salazar-mateo": ['Family', 'Heritage & Roots', 'Extended Family', "Carlota Salazar Mateo"],
      "carolina-ranilla": ['Family', 'Heritage & Roots', 'Extended Family', "Carolina Ranilla"],
      "ernesto-herrera": ['Family', 'Heritage & Roots', 'Extended Family', "Ernesto Herrera"],
      "eugenio-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Eugenio Astocondor"],
      "eugenio-astocondor-fuertes": ['Family', 'Heritage & Roots', 'Extended Family', "Eugenio Astocondor Fuertes"],
      "eugenio-astocondor-salazar": ['Family', 'Heritage & Roots', 'Extended Family', "Eugenio Astocondor Salazar"],
      "eugenio-astocondor-salazar-lopez": ['Family', 'Heritage & Roots', 'Extended Family', "Eugenio Astocondor Salazar Lopez"],
      "fatima-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Fatima Astocondor"],
      "fernando-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Fernando Astocondor"],
      "fernando-astocondor-salazar-lopez": ['Family', 'Heritage & Roots', 'Extended Family', "Fernando Astocondor Salazar Lopez"],
      "fernando-pallete": ['Family', 'Heritage & Roots', 'Extended Family', "Fernando Pallete"],
      "gabriel-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Gabriel Astocondor"],
      "hector-briceno": ['Family', 'Heritage & Roots', 'Extended Family', "Hector Briceno"],
      "janet-ranilla-cateriano": ['Family', 'Heritage & Roots', 'Extended Family', "Janet Ranilla Cateriano"],
      "jorge-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Jorge Astocondor"],
      "jose-dalicio-lopez-lopez": ['Family', 'Heritage & Roots', 'Extended Family', "Jose Dalicio Lopez Lopez"],
      "lorenzo-lu": ['Family', 'Heritage & Roots', 'Extended Family', "Lorenzo Lu"],
      "lucila-dongo-salcedo": ['Family', 'Heritage & Roots', 'Extended Family', "Lucila Dongo Salcedo"],
      "luis-fernando-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Luis Fernando Astocondor"],
      "luisa-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Luisa Astocondor"],
      "alcira-astocondor-salazar-lopez": ['Family', 'Heritage & Roots', 'Extended Family', "Alcira Astocondor Salazar Lopez"],
      "maria-jesus-cateriano-dongo": ['Family', 'Heritage & Roots', 'Extended Family', "Maria Jesus Cateriano Dongo"],
      "milagros-herrera": ['Family', 'Heritage & Roots', 'Extended Family', "Milagros Herrera"],
      "monica-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Monica Astocondor"],
      "oscar-ranilla": ['Family', 'Heritage & Roots', 'Extended Family', "Oscar Ranilla"],
      "oscar-ranilla-cateriano": ['Family', 'Heritage & Roots', 'Extended Family', "Oscar Ranilla Cateriano"],
      "paola-pallete": ['Family', 'Heritage & Roots', 'Extended Family', "Paola Pallete"],
      "paola-ranilla": ['Family', 'Heritage & Roots', 'Extended Family', "Paola Ranilla"],
      "raul-ranilla": ['Family', 'Heritage & Roots', 'Extended Family', "Raul Ranilla"],
      "raul-ranilla-cateriano": ['Family', 'Heritage & Roots', 'Extended Family', "Raul Ranilla Cateriano"],
      "sebastian-astocondor": ['Family', 'Heritage & Roots', 'Extended Family', "Sebastian Astocondor"],
      "sergio-ranilla-ranilla": ['Family', 'Heritage & Roots', 'Extended Family', "Sergio Ranilla Ranilla"],
      "sergio-ranilla-rondon": ['Family', 'Heritage & Roots', 'Extended Family', "Sergio Ranilla Rondon"],
      "victoriano-cateriano": ['Family', 'Heritage & Roots', 'Extended Family', "Victoriano Cateriano"],

      // Family section - Other pages
      'my-story': ['Family', 'My Story'],
      'photo-tags': ['Directory Profile', 'Photo Tags'],


      // Spanish versions - mirror English hierarchy
      'heritage-roots-es': ['Family', 'Heritage & Roots'],
      'extended-family-es': ['Family', 'Heritage & Roots', 'Extended Family'],
      'ancestry-es': ['Family', 'Heritage & Roots', 'Ancestry'],
      'my-story-es': ['Family', 'My Story'],

      'jorge-ranilla-es': ['Family', 'Heritage & Roots', 'Jorge'],
      'shane-ranilla-es': ['Family', 'Heritage & Roots', 'Shane'],
      'alyssa-ranilla-es': ['Family', 'Heritage & Roots', 'Alyssa'],
      'victor-andres-ranilla-es': ['Family', 'Heritage & Roots', 'Victor Andres'],
      'maria-eugenia-ranilla-es': ['Family', 'Heritage & Roots', 'Maria Eugenia'],
      'jorge-luis-ranilla-es': ['Family', 'Heritage & Roots', 'Jorge Luis'],
      'sylvia-ines-astocondor-es': ['Family', 'Heritage & Roots', 'Sylvia Ines'],

      // Gallery section - Travel pages
      'travel': ['Gallery', 'Travel'],
      'cancun': ['Gallery', 'Travel', 'Mexico', 'Cancun'],
      'cozumel': ['Gallery', 'Travel', 'Mexico', 'Cozumel'],
      'lima': ['Gallery', 'Travel', 'Peru', 'Lima'],
      'cusco': ['Gallery', 'Travel', 'Peru', 'Cusco'],
      'tokyo': ['Gallery', 'Travel', 'Japan', 'Tokyo'],
      'osaka': ['Gallery', 'Travel', 'Japan', 'Osaka'],
      ...
      'at-a-glance': ['Professional', 'At a Glance'],
      'family-archive': ['Professional', 'Family Archive'],
      'resume': ['Professional', 'Resume'],

      // Baptism pages (English & Spanish, main + godparent subpages)
      'baptism': ["Alyssa's Baptism"],
      'baptism-es': ["Alyssa's Baptism"],
      'baptism-godfather': ["Alyssa's Baptism", "Letter to Godfather"],
      'baptism-godfather-es': ["Alyssa's Baptism", "Letter to Godfather"],
      'baptism-godmother': ["Alyssa's Baptism", "Letter to Godmother"],
      'baptism-godmother-es': ["Alyssa's Baptism", "Letter to Godmother"],

      // Blog section
      'latest-posts': ['Blog', 'Latest Posts'],
      'life-updates': ['Blog', 'Life Updates']
    };
    ...
    // Special handling for the clean /es URL
    if (file === "es") {
  ...
  (function injectFamilyBioAlbumLink() {
    ...
    const excludedFiles = new Set([
      ...
      'baptism-es',
      'baptism-godfather',
      'baptism-godfather-es',
      'baptism-godmother',
      'baptism-godmother-es',
      'extended-family',
      'family-tree',
      'heritage-roots'
    ]);
    ...
    albumLink.href = `../gallery/family/person?person=${encodeURIComponent(slug)}&name=${encodeURIComponent(displayName)}`;
  ...
  (function injectPublicProfileClaimPrompt() {
    ...
    const profileConfig = (() => {
      ...
      if (/\/people\/[^/]+(?:\.html)?$/i.test(pathname) && section === 'People') {
        return {
          source: 'people',
          albumFolder: 'people',
          excludedFiles: new Set(['index', 'patricia-malca-gallery'])
        };
      }
    ...
    if (!profileConfig || profileConfig.excludedFiles.has(file)) return;
    ...
    const claimSlugRaw = document.body.getAttribute('data-claim-id') || pageSlug;
    const claimSlug = profileConfig.source === 'people' ? claimSlugRaw.replace(/-\d+$/i, '') : claimSlugRaw;
    const displayName = (titleEl.textContent || document.body.getAttribute('data-title') || titleFromSlug(claimSlug)).trim();
    
    const fallbackAlbumHref = `../gallery/${profileConfig.albumFolder}/person?person=${encodeURIComponent(claimSlug)}&name=${encodeURIComponent(displayName)}`;
    const albumHref = existingAlbumLink?.getAttribute('href') || fallbackAlbumHref;
    const profileHref = `../family-directory/profile?claim=${encodeURIComponent(claimSlug)}&name=${encodeURIComponent(displayName)}&source=${encodeURIComponent(profileConfig.source)}`;
