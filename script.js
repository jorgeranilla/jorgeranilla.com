document.addEventListener("DOMContentLoaded", () => {
  ...
  (function injectSharedHeader() {
    ...
    // Find the "Cursor" folder index (our project root)
    const cursorIndex = pathParts.indexOf('Cursor');

    // Get parts after "Cursor" folder
    const relativePathParts = cursorIndex !== -1 ? pathParts.slice(cursorIndex + 1) : pathParts;
    ...
    // Root (Cursor/index.html): dirParts = [] → depth = 0
